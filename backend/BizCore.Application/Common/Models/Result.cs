namespace BizCore.Application.Common.Models;

// Every command/query returns a Result<T>
// Forces you to ALWAYS handle success and failure
// No silent failures, no unhandled nulls
...
public class Result<T>
{
    ...
    // Factory methods — readable, self-documenting
